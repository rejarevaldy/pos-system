    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="github-link">
                <a href="https://github.com/dropways/deskapp" target="_blank"><img src="{{ asset('assets/vendors/images/github.svg')}}"
                        alt="" /></a>
            </div>
        </div>
    </div>
            ...
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li><a href="{{ asset('assets/video-player.html')}}">Video Player</a></li>
                    ...
                    <li>
                        <a href="https://dropways.github.io/deskapp-free-single-page-website-template/"
                            ...
                            <span class="mtext">Landing Page
                                <img src="{{ asset('assets/vendors/images/coming-soon.png')}}" alt="" width="25" /></span>
                        </a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="user-list">
                            <ul>
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="name-avatar d-flex align-items-center pr-2">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('assets/vendors/images/photo1.jpg')}}" class="border-radius-100 box-shadow"
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="name-avatar d-flex align-items-center pr-2">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('assets/vendors/images/photo2.jpg')}}" class="border-radius-100 box-shadow"
                                                width="50" height="50" alt="" />
                                        </div>
                                        <div class="txt">
                                            <span class="badge badge-pill badge-sm" data-bgcolor="#e7ebf5"
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="name-avatar d-flex align-items-center pr-2">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('assets/vendors/images/photo3.jpg')}}" class="border-radius-100 box-shadow"
                                                width="50" height="50" alt="" />
                                        </div>
                                        <div class="txt">
                                            <span class="badge badge-pill badge-sm" data-bgcolor="#e7ebf5"
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="name-avatar d-flex align-items-center pr-2">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('assets/vendors/images/photo4.jpg')}}" class="border-radius-100 box-shadow"
                                                width="50" height="50" alt="" />
                                        </div>
                                        <div class="txt">
                                            <span class="badge badge-pill badge-sm" data-bgcolor="#e7ebf5"
                ...
                <div class="col-lg-4 col-md-12 mb-20">
                    <div class="card-box height-100-p pd-20 min-height-200px">
                        <div class="max-width-300 mx-auto">
                            <img src="{{ asset('assets/vendors/images/upgrade.svg')}}" alt="" />
                        </div>
                    ...
                    <tbody>
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('assets/vendors/images/photo4.jpg')}}" class="border-radius-100 shadow"
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('assets/vendors/images/photo5.jpg')}}"" class="border-radius-100 shadow"
                                            width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('assets/vendors/images/photo6.jpg')}}" class="border-radius-100 shadow"
                                            width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('assets/vendors/images/photo9.jpg')}}" class="border-radius-100 shadow"
                                            width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('assets/vendors/images/photo1.jpg')}}" class="border-radius-100 shadow"
                                            width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('assets/vendors/images/photo2.jpg')}}" class="border-radius-100 shadow"
                                            width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('assets/vendors/images/photo8.jpg')}}" class="border-radius-100 shadow"
                                            width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
            ...
            <div class="row">
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('assets/vendors/images/medicine-bro.svg')}}" alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('assets/vendors/images/remedy-amico.svg')}}" alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('assets/vendors/images/paper-map-cuate.svg')}}" alt="" />
                        </div>
                        <div class="content">
